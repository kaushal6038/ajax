...
SECRET_KEY = '_*!vai-b=x-9k)o)&zd^=1o0$v#@%2izwcj2o(5^8d5eqly)fh'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'kaushal.ameotech@gmail.com'
EMAIL_HOST_PASSWORD = 'KH@ameo675'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'userauth.models.MyCustomAuthentication',
